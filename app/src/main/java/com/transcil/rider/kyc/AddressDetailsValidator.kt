/**
 * Validates present-address fields (lines, city, state, pincode) for KYC address step.
 * Supports optional API-provided state allow-list; falls back to [IndianStates] offline list.
 */
...
/** `object`: pure validation — no Android dependencies, safe for unit tests. */
