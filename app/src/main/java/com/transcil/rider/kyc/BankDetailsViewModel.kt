/**
 * ViewModel for standalone bank-details screen — validates locally, saves draft, marks step complete.
 * No bank-verify API yet; completion is local-only until server integration lands.
 */
