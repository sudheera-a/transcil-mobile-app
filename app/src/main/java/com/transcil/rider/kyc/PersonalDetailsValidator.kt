/**
 * Validates personal-details fields (name, email, DOB, gender) for KYC step 1.
 * Returns string-resource error IDs; enforces allowed email domains and minimum age 18.
 */
...
/** `data class`: per-field validation errors; null field = no error for that field. */
...
/** `object`: allowed consumer email domains — rejects disposable/unknown providers. */
...
/** `object`: shared validation logic for CreatePersonalAccount and inline accordion form. */
