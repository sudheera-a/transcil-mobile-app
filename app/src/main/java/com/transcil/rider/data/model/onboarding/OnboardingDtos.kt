/**
 * DTOs for rider onboarding: journey choice, profile, address, progress steps, reference geography.
 * [OnboardingRepository] converts between these API shapes and core enums like [JourneyType]/[Gender].
 *
 * Kotlin notes:
 * - [StateOption] is a UI-facing row (spinner shows [name], API submits [code]); overrides [toString].
 * - `@SerializedName` with `alternate` handles inconsistent casing from reference-data endpoints.
 */
package com.transcil.rider.data.model.onboarding
