/**
 * ViewModel for the intro carousel — holds slide content and page index, emits navigate-to-welcome event.
 * Stateless slide data lives in [pages]; navigation is a one-shot LiveData flag consumed by the Activity.
 */
...
/** `data class`: one intro slide — image and string resource IDs for title/description. */
...
class OnboardingViewModel : BaseViewModel() {
    ...
    // `val`: immutable slide list — defined once, shared across page changes.
    val pages = listOf(
