/**
 * RecyclerView adapter for wallet transaction rows; styles credit vs debit amounts.
 */
...
import com.transcil.rider.databinding.ItemWalletTransactionBinding
...
class WalletTransactionAdapter : RecyclerView.Adapter<WalletTransactionAdapter.Holder>() {
    ...
    // ViewHolder holds row ViewBinding; bind() maps one WalletTransaction to the row UI.
    class Holder(
