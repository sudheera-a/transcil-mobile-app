/**
 * Settings toggles and one-shot navigation (help/terms content, sign-out).
 * [SettingsNavEvent] sealed class keeps UI routing out of business logic.
 */
...
// sealed class = closed set of navigation outcomes for exhaustive when in the Fragment.
