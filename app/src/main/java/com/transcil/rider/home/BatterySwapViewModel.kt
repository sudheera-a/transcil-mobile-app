/**
 * Battery swap tab state and one-shot [BatterySwapEvent] signals for cross-tab navigation.
 */
...
// sealed class variants represent discrete UI events the Fragment handles once.
