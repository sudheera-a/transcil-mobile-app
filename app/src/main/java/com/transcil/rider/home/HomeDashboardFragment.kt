/**
 * Home tab UI: greeting, KYC status cards, vehicle carousel, and quick actions.
 * Observes [HomeDashboardViewModel] and delegates tab switches to [HomeDashboardActivity].
 */
...
import com.transcil.rider.databinding.FragmentHomeDashboardBinding
import com.transcil.rider.databinding.ItemHomeVehicleCardBinding
import com.transcil.rider.payment.PaymentActivity
import com.transcil.rider.rental.VehiclesActivity

// Fragment = reusable screen slice hosted by an Activity (lighter than a new Activity per tab).
class HomeDashboardFragment : Fragment() {

    // ViewBinding: nullable backing field cleared in onDestroyView to avoid leaks.
    private var _binding: FragmentHomeDashboardBinding? = null
    private val binding get() = _binding!!

    // by viewModels() scopes the ViewModel to this Fragment's lifecycle.
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        bindActions()
        // LiveData.observe + viewLifecycleOwner stops updates after the view is destroyed.
