/**
 * Map tab UI: list of nearby swap stations with navigate actions.
 */
...
import com.transcil.rider.databinding.FragmentNearbyHubsBinding
...
class NearbyHubsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // LinearLayoutManager = vertical list; adapter inflates one row layout per station.
