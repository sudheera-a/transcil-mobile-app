/**
 * Wallet tab: balance summary and a scrollable recent-transactions list.
 * Launches [PaymentActivity] for rent payment; other actions show stub toasts.
 */
...
import com.transcil.rider.databinding.FragmentWalletBinding
...
class WalletFragment : Fragment() {
    ...
    // RecyclerView.Adapter renders the transaction list below the balance cards.
