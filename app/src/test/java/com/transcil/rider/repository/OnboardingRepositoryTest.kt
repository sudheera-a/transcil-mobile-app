/**
 * Unit tests for [OnboardingRepository]: role mapping, profile/address/reference API payloads.
 */
...
class OnboardingRepositoryTest {
    ...
    fun putReference_mapsE164AndRelation() = runBlocking {
        var captured: com.transcil.rider.data.model.kyc.ReferenceUpsertRequest? = null
        var key: String? = null
        val api = object : FakeTranscilApi() {
            override suspend fun putReference(
                idempotencyKey: String,
                body: com.transcil.rider.data.model.kyc.ReferenceUpsertRequest,
            ): ApiResponse<com.transcil.rider.data.model.kyc.ReferenceData> {
                key = idempotencyKey
                captured = body
                return ApiResponse(
                    com.transcil.rider.data.model.kyc.ReferenceData(relation = body.relation),
                    null,
                    null,
                )
            }
